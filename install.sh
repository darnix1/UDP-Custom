...
install_ADMRufu() {
  ...
  cd /etc
  wget https://raw.githubusercontent.com/darnix1/UDP-Custom/main/ADMRufu.tar.xz >/dev/null 2>&1
...
install_ChumoGH() {
  ...
  cd /etc
  wget https://raw.githubusercontent.com/darnix1/UDP-Custom/main/ChuGH-5.7u/adm-lite.tar.gz >/dev/null 2>&1
