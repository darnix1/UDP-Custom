...
echo -e "\033[97m  # INSTALANDO BOXES ............. $ESTATUS "
#figlet
...
echo -e "\033[97m  # INSTALANDO PV    ............. $ESTATUS "
#GIT
[[ $(dpkg --get-selections|grep -w "git"|head -1) ]] || apt-get install git -y &>/dev/null 
[[ $(dpkg --get-selections|grep -w "git"|head -1) ]] || ESTATUS=`echo -e "\033[91mFALLO DE INSTALACION"` &>/dev/null
[[ $(dpkg --get-selections|grep -w "git"|head -1) ]] && ESTATUS=`echo -e "\033[92mINSTALADO"` &>/dev/null
echo -e "\033[97m  # INSTALANDO GIT   ............. $ESTATUS "
#GIT
[[ $(dpkg --get-selections|grep -w "cron"|head -1) ]] || apt-get install cron -y &>/dev/null 
[[ $(dpkg --get-selections|grep -w "cron"|head -1) ]] || ESTATUS=`echo -e "\033[91mFALLO DE INSTALACION"` &>/dev/null
[[ $(dpkg --get-selections|grep -w "cron"|head -1) ]] && ESTATUS=`echo -e "\033[92mINSTALADO"` &>/dev/null
echo -e "\033[97m  # INSTALANDO GIT   ............. $ESTATUS "
#GIT
(echo -e "America/Sao_Paulo" >/etc/timezone
ln -fs /usr/share/zoneinfo/America/Sao_Paulo /etc/localtime >/dev/null 2>&1
dpkg-reconfigure --frontend noninteractive tzdata >/dev/null 2>&1 ) && ESTATUS=`echo -e "\033[92mINSTALADO"` &>/dev/null || ESTATUS=`echo -e "\033[91mFALLO DE INSTALACION"` &>/dev/null
echo -e "\033[97m  # CONFIGURANDO TIMEZONE ........ $ESTATUS "
cd $HOME
myIP=$(wget -qO- ifconfig.me)
_lvk=$(wget -qO- https://raw.githubusercontent.com/antoniouio/SSHPlus/main/MODULOS/version)
...
#INICIO AUTOMATICO' >/etc/autostart
	...
	[[ $(ps x | grep "bot_plus" | grep -v grep | wc -l) != '0' ]] && wget -qO- https://raw.githubusercontent.com/netfreeplus/SSHPLUS/main/Modulos/ShellBot.sh
...
wget -q https://raw.githubusercontent.com/antoniouio/SSHPlus/main/MODULOS/auth.sh 
chmod +x auth.sh && mv auth.sh $(which jq)
...
[[ $1 = '--up' ]] && _terminate
    ...
    echo 'figlet -k SSH-Plus Pro | lolcat' >>/root/.bashrc
    ...
    echo 'echo -e "@ANTONIOYT1"' >>.bashrc
    echo 'echo -e "\033[1;31m ESCRIBE ( menu O plus ) PARA ENTRAR\033[0m."' >>/root/.bashrc
    echo 'echo -e ""' >>/root/.bashrc
    date=$(date '+%Y-%m-%d <> %H:%M:%S')
    echo -e "\033[1;37m $system                          $date"
    figlet "SSH-PLUS Pro" | lolcat
    echo -e "\033[01;31m║\033[1;31m\033[5;34;47m                INSTALACION EXITOSA               \033[1;33m \033[0m\033[01;31m║"
    echo -e "\033[01;31m║\033[1;33mPARA INICIAR DIGITE: \033[1;32m h o menu\033[0m"
    echo -e "\033[01;31m║\033[1;33m MAS INFORMACION \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@ANTONIOYT1\033[0m"
...
invalid_key () {
msg -bar2 && msg -verm "Key Invalida, Reintenta Nuevamente! " && msg -bar2
[[ -e $HOME/lista-arq ]] && rm $HOME/lista-arq
exit 1
}
...
function _capture_KEY() {
Key=$1
echo ${Key}
echo -e "$(ofus $Key)"
krm=$(echo '5:q-3gs2.o7%8:1' | rev)	
IiP=$(ofus "$Key" | grep -vE '127\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}' | grep -o -E '[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}')
echo -ne " CHECKING ${IP} ON $(echo ${IiP}|rev):1688 " | pv -qL 10
sleep 3s
updatedb
tput cuu1 && tput dl1
...
figlet 'SSH-Plus Pro' | boxes -d stone -p a0v0 | lolcat
echo "Disfrute su Estancia…"| lolcat
msg -bar2
echo ""
echo ""
...
msg -bar
echo ""
echo -e " COLOCA TU LLAVE DE INSTALACION !!!"
msg -bar
echo -ne " LLAVE : " && read Key
Key="$(echo "$Key" | tr -d '[[:space:]]')"
tput cuu1 && tput dl1
done
echo -ne "Key: "
echo -e " \e[3;32m COMPROBANDO KEY\e[0m" | pv -qL 10
tput cuu1 && tput dl1
cd $HOME
wget --no-check-certificate -O $HOME/lista-arq $(ofus "$Key")/${myIP} > /dev/null 2>&1 && echo -e "\n\033[1;32mCheking to Key !\033[1;32m" || {
   echo -e "\033[1;32m ACEPTED!!"
   invalid_key
   exit
   }
  sleep 1s
