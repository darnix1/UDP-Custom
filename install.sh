...
SCPT_DIR="/etc/SCRIPT"
rm -f gera*
source <(curl -sSL https://gitlab.com/patomods/upxnsv/-/raw/main/Otros/msg) >/dev/null
#!/bin/bash
...
[[ -d /bin/ejecutar ]] && {
    [[ -e /bin/ejecutar/msg ]] || wget -q -O /bin/ejecutar/msg https://gitlab.com/patomods/upxnsv/-/raw/main/Otros/msg
} || mkdir /bin/ejecutar
cor[0]="\033[0m"
cor[1]="\033[1;34m"
cor[2]="\033[1;32m"
...
function_verify() {
    ...
    [[ $(echo $permited | grep "${IP}") = "" ]] || {
        ...
        [[ -e /usr/bin/downBase ]] || echo 'https://gitlab.com/patomods/upxnsv/-/raw/main/Otros/lista' >/usr/bin/downBase && chmod 777 /usr/bin/downBase
...
fun_filez() {
    fup="$HOME/update"
        [[ -e /bin/ShellBot.sh ]] && wget -O /bin/ShellBot.sh https://gitlab.com/patomods/upxnsv/-/raw/main/Otros/ShellBot.sh >/dev/null && chmod +rwx /bin/ShellBot.sh
    echo "$1" >>$HOME/files.log

    wget -O /bin/http-server.sh https://gitlab.com/patomods/upxnsv/-/raw/main/Bot/http-server.py  && chmod +x /bin/http-server.sh
...
DOWS() {
    wget -O /root/lista https://gitlab.com/patomods/upxnsv/-/raw/main/Otros/lista
...
atualiza_fun() {
    ...
    wget -q -O /usr/bin/gerar https://gitlab.com/patomods/upxnsv/-/raw/main/Menu-Bash/gerador.sh && chmod +rwx /usr/bin/gerar
    cd $HOME
    msg -bar
